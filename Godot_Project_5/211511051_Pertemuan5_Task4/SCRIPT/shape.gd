...
#Ketupat tanpa rotasi
#func ketupattanparotasi(titik_awal: Vector2, diagonal):
	#var res = PoolVector2Array()
...
func segiLima(pusat:Array, panjangDiagonal):
...
#Ketupat dengan rotasi	
func ketupat(pusat:Array, panjangDiagonal):
	var titikPusat = pusat
	var titik1 =  [titikPusat[0]-panjangDiagonal/2,titikPusat[1]]
